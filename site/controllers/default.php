...
class RaceControllersDefault extends JControllerBase
{
    ...
    public function execute()
    {
        ...
        JLoader::register('RaceModelsDefault', JPATH_COMPONENT_ADMINISTRATOR . '/models/default.php');
        JLoader::register($modelClass, JPATH_COMPONENT_ADMINISTRATOR . '/models/' . $viewName . '.php');
